...
class AlternativeValidator:
    ...
    Marks the alternative as VALIDATED or REJECTED.
    """

    def __init__(self, rule_engine: RuleEngineAdapter):
        self.rule_engine = rule_engine

    def validate(self, alternative: AlternativeResult) -> AlternativeResult:
        rule_result = self.rule_engine.analyze(alternative.candidate_command)
